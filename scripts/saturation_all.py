...
# All five pilot trajectories, in descending-length order for the table.
TRAJ_IDS = [
...
# Previously recorded numbers for the two already-analyzed trajectories.
EXPECTED = {
...
def main():
    ...
    out = []
    w = out.append
    w("# State Saturation Trap — all five pilot trajectories")
    w("")
